...
echo "     reach use <agent_id>"
echo ""
echo "  5. Install the agent on the remote machine."
echo "     The step 3 response includes a 'commands' field with ready-to-run install"
echo "     commands for Linux and Mac. Copy the relevant one and run it on the target machine:"
echo ""
echo "     Linux:          commands.agent_linux"
echo "     Mac (ARM):      commands.agent_mac_arm"
echo "     Mac (Intel):    commands.agent_mac_intel"
echo ""
echo "  6. Test it:"
