...
<table>
  <tr>
    <td width="50%" valign="top"><a href="docs/images/login.png"><img src="docs/images/login.png" alt="Sign in" width="100%"></a><br><b>Sign in</b> - tenant-scoped console login (tenant name, username, password); platform admins sign in separately.</td>
    <td width="50%" valign="top"><a href="docs/images/agents.png"><img src="docs/images/agents.png" alt="Agents list" width="100%"></a><br><b>Agents</b> - every host and Kubernetes agent in your tenant, with status, policy mode, and cluster-RBAC drift at a glance.</td>
  </tr>
  <tr>
    <td width="50%" valign="top"><a href="docs/images/new-agent.png"><img src="docs/images/new-agent.png" alt="New agent" width="100%"></a><br><b>New agent</b> - enroll a host or Kubernetes agent: pick a version, execution mode, and access.</td>
    <td width="50%" valign="top"><a href="docs/images/rbac-drift.png"><img src="docs/images/rbac-drift.png" alt="Cluster RBAC drift" width="100%"></a><br><b>Cluster RBAC drift</b> - an agent's effective permissions diffed against the acknowledged baseline, down to the exact verbs.</td>
  </tr>
  <tr>
    <td width="50%" valign="top"><a href="docs/images/fleets.png"><img src="docs/images/fleets.png" alt="Fleets" width="100%"></a><br><b>Fleets</b> - reusable-join-token groups of host agents (autoscaling groups). Members inherit the fleet's mode, tags, and grants; grant drift is flagged and reconciled per member or fleet-wide.</td>
    <td width="50%" valign="top"><a href="docs/images/jobs.png"><img src="docs/images/jobs.png" alt="Jobs history" width="100%"></a><br><b>Jobs</b> - command history across the fleet; writes in <code>approved</code> mode are gated (note the rejected <code>kubectl delete</code>).</td>
  </tr>
</table>
