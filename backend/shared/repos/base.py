...
class IApprovalRepo(Protocol):
    ...
    def search_by_tenant(self, tenant_id: str, *, status: Optional[str] = None, agent_id: Optional[str] = None, requested_by: Optional[str] = None, kind: Optional[str] = None, q: Optional[str] = None, limit: int = 20, offset: int = 0) -> tuple: ...
